    ...
    <div class="px-5 py-5">
        ...
        <div class="flex">
            ...
            <div
                ...
                <a href="#">
                    <img class="p-8 rounded-md" src="@/assets/background.jpg" alt="product image" />
                </a>
                <div class="px-5 pb-5">
                    <a href="#">
            ...
            <div
                ...
                <img class="p-8 rounded-md" src="@/assets/background.jpg" alt="product image" />
                <div class="px-5 pb-5">
                    <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">THE CATCHER IN THE
                        RYE</h5>
                    <div class="flex items-center mt-2.5 mb-5">
                        <div class="flex items-center space-x-1 rtl:space-x-reverse">
                            <svg class="w-4 h-4 text-yellow-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
